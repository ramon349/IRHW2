...
do
    ...
    do
        ...
        java -jar RankLib.jar -load "${models_path}/${year}_base_model_f${i}.txt" -rank "${base_data}/test.txt" -score "${output_path}/score/base_ScoreFile.txt"
        ...
        java -jar RankLib.jar -load "${models_path}/${year}_aug_model_f${i}.txt" -rank "${aug_data}/test.txt" -score "${output_path}/score/aug_ScoreFile.txt"
